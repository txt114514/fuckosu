...
from .observation import CandidateObservation, ObjectType, Point2D
from .outcome import (
...
class TrainingCandidateRecord:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.observation, CandidateObservation):
            raise TypeError("observation 必须是 CandidateObservation")
...
class OutcomeTrainingSample:
    ...
    def __post_init__(self) -> None:
        ...
        if self.action is not DecisionAction.CLICK:
