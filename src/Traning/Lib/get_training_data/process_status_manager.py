...
from Traning.Lib.get_training_data.config_loader import load_process_steps_config_or_default
...
class ProcessStatusManager:
    def __init__(
        ...
        self.process_steps = (
            ...
            else load_process_steps_config_or_default(default_steps=PROCESS_STEPS)
        )
